...
function ModalWork(props) {
  ...
  const postExp = () =>{
    axios.post('http://127.0.0.1:8000/accounts/api/experience/',{ 
        ...
        <Form onSubmit={()=>{postExp()}}>
            <div className={`${styles.inputWork}`}>
                <Form.Group style={{width: '100%'}} className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control style={{width: '90%', borderRadius: '1rem'}} type="text" placeholder="Sample Tech, Inc." onChange={(e) => {setAsignment(e.target.value)}}/>
                </Form.Group>
                <Form.Group style={{width: '100%'}} className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control style={{paddingLeft:'20px', width: '90%', borderRadius: '1rem'}} type="text" placeholder="Lead Developer" onChange={(e) => {setOrganisation(e.target.value)}} />
                </Form.Group>
            </div>
            <Form.Group>
                <Form.Label style={{fontWeight: '500', paddingLeft: '5px', marginTop:'1rem'}}>Job description</Form.Label>
                <Form.Control as="textarea" style={{paddingLeft:'20px', width: '100%', height:'86px', borderRadius: '1rem'}} type="number" placeholder="Lead Developer" onChange={(e) => {setDescription(e.target.value)}} />
            </Form.Group>
