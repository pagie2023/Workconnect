...
// import { addLanguage} from '../../../features/LanguageFeature'
...
function ModalLanguage(props) {
  ...
  const postLanguage = () =>{
    if(language != ''){
      axios.post('http://127.0.0.1:8000/accounts/api/language/',{ 
          language: language, 
          user_id : user_id,  
          lvl : lvl})
